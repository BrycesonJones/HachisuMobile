...
- **Google account information (optional).** If you sign in with Google, our
  authentication provider receives basic information from your Google account (such as
  your email address) to sign you in. We do not receive your Google password.
...
- **From third-party sign-in** — if you choose to sign in with Google.
...
- **Google sign-in.** Signing in with Google is optional; email sign-in is available.
